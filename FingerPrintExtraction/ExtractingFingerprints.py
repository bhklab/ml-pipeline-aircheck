...
from .fingerprints import HitGenMACCS, HitGenECFP4, HitGenECFP6, HitGenFCFP4, HitGenFCFP6, HitGenRDK, HitGenAvalon, HitGenTopTor, HitGenAtomPair, HitGenBinaryECFP4
...
def main():
    ...
    fingerprint_classes = {'ECFP4-count': HitGenECFP4()}
    fingerprint_classes = {'ECFP4-binary': HitGenBinaryECFP4()}
